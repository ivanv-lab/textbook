...
namespace textbook
{
    public partial class Teory : Form
    {
        ...
        public int lc;
        public bool lic;
        List<string> lekcii = new List<string> { "Лекция 1" };

        public Teory()
        {
            InitializeComponent();
            lekcii.AddRange(File.ReadAllLines(Environment.CurrentDirectory + "\\Teoria\\Spisok.txt"));
        ...
        private void Teory_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            lekcii.Add(listfile);
            File.AppendAllText(Environment.CurrentDirectory + "\\Teoria\\Spisok.txt", listfile + Environment.NewLine);
            for (int i = 0; i < listBox1.Items.Count; i++)
            {
                ...
                {
                    File.Move(filename, Environment.CurrentDirectory + "/Teoria/" + listfile + ".docx");
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            richTextBox1.Clear();
            rich = "";
            filename = Environment.CurrentDirectory + "\\Teoria\\" + listBox1.SelectedItem + ".docx";
            OpenClass obj = new OpenClass(filename, rich);
            obj.Open(ref rich);
            richTextBox1.Text = rich;
        }
